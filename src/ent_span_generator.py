...
from lib.util import parse_tag
from lib.util import start_of_chunk
from lib.util import end_of_chunk
...
class EntSpanGenerator:
    ...
    def __init__(self, vocab: Vocabulary, max_entity_num) -> None:
        self.vocab = vocab
...
if __name__ == '__main__':
    ent_span_generator = EntSpanGenerator(None)
    y = ['O', "B", "I", "E", "U", "O", "O", "U"]
    y = [yy if yy == "O" else yy + "-ENT" for yy in y]
    t_entity = ent_span_generator.get_entity(y)
    print(t_entity)
